...
export class SuperadminCreateAdminComponent {
...
async onCreateAdmin(){
  ...
  this.DataAdmin={user_cat:this.userData.usertype,
...
console.log(this.DataAdmin)
  ...
  this.combinedFormData.append('user_cat', this.userData.usertype);
  console.log('got',this.combinedFormData)
